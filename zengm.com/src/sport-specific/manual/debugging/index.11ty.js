...
module.exports = class {
	...
	render({ gameName, sport }) {
		return `If you have a problem, please [tell me](/contact/)! I want to make ${gameName} as bug free as possible.
...
- ${gameName} version (can be seen in the bottom right corner of the game)
...
Read about [Quota Errors](/${sport}/manual/debugging/quota-errors/) if you're getting errors about hard drive space.

## Last resort

If nothing works, you might need to do a [Hard Reset](/${sport}/manual/debugging/hard-reset/).`;
	}
};
