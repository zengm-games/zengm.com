...
<p><b>Method 3:</b> Try manually emptying your cache. In Chrome, from the main menu (... in the top right) go to "Delete browsing data...". Make sure you select "Cached images and files" and <i>do not select</i> "Cookies and other site data" because "other site data" is where ${gameName} stores all your leagues. Then try closing all open tabs with ${gameName} and opening it again, like above.</p>
