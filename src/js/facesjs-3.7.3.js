var faces = (function (exports) {
	...
	var svgs = {
		...
		body: {
			body: '<path class="body" d="M10 600s0-50 60-70 70-50 70-50l60-180 60 180s10 30 70 50 60 70 60 70" fill="$[skinColor]" stroke="#000" stroke-width="6"/>',
			body2:
			...
			body3:
				'<path d="M10 600s-10-70 50-70c10 0 0-10 60-20 0 0 50-210 80-210s80 210 80 210c60 10 50 20 60 20 60 0 50 70 50 70" fill="$[skinColor]" stroke="#000" stroke-width="6"/><path d="M71 545s46.9-3 82.1 10M329 545s-46.9-3-82.1 10M324 537s5.5-7.5 22-7m-271 7s-5.5-7.5-22-7"/>',
			body4:
		...
		facialHair: {
			...
			soul: '<path class="shp0" d="M188 458c2-2 22-2 24 0s-8 16-12 16-14-14-12-16z" fill="$[hairColor]" stroke="#000"/>',
			"wilt-sideburns-long":
			...
			wilt: '<path fill-rule="evenodd" class="shp0" d="M200 405c55 0 55 20 55 35 0 0 5 40-5 55-5 5-35 15-50 15s-46.67-10-50-15c-10-15-5-55-5-55 0-15 0-35 55-35zm-45 35c0 5 5 5 25 5 10 0 10-5 20-5s10 5 20 5c20 0 25 0 25-5 0-20-15-15-45-15s-45-5-45 15z" fill="$[hairColor]" stroke="#000"/>',
		},
		glasses: {
			facemask:
